...
@interface ZFImagePaperViewController ()
...
@implementation ZFImagePaperViewController
...
- (void)setUpSubViews {
    if (!_paperImage) {
        _paperImage = [[UIImageView alloc]initWithFrame:CGRectMake(0, 92/2.0, ZFScreenWidth, ZFScreenHeight-92/2.0-54/2.0)];
        [_paperImage sd_setImageWithURL:[NSURL URLWithString:_detailModel.taobao_pic_url] placeholderImage:nil];
    }
...
- (void)clickEvent:(UIButton *)sender {
    if (sender.tag==10) {
        ...
        //下载图片
        [_paperImage sd_setImageWithURL:[NSURL URLWithString:_detailModel.taobao_pic_url] placeholderImage:nil completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
